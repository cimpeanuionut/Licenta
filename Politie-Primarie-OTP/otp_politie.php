...
header("location:http://localhost/Politie/primapaginaserverpolitie.php");
...
?>
<form method="post" action="otp_politie.php">
<table>
<tr>
			<td>OTP:</td>
...
<ul>
	<li><a href="http://localhost/Primarie/login_server_primarie.php">Logout</a></li>
